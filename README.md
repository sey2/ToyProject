...
그 후 **Ctr + v** 키를 눌러 **비주얼 블록 모드**에 진입하는데 비주얼 블록 모드란 원하는 부분을 상자 처럼 선택 할 수 있다.<br>
...
그 후 **c**를 써서 삭제 했던 **y1** 문자를 **P**를 이용하여 다시 전부 채워 넣는다.<br>
다시 한번 비주얼 블록 모드에 진입하여 **}g**로 문단 끝으로 이동하고 **Ctrl+A**를 이용해 숫자 하나를 증가시키고 <br>
나머지는 직접 이동 하며 **r**키를 이용해 숫자를 하나씩 바꿔준다. <br>
** 이렇게 하면 최고 점수인 34점이 나오게 된다.**<br>
