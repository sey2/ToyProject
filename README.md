...
**이 문제는 삽입하는 과정이 2번 반복되기 때문에 매크로를 이용하여 문제를 해결 할 수 있습니다.** > <br>
L을 사용해 마지막 라인으로 이동한 후 qa를 입력해 이름 a인 매크로를 기록하기 시작합니다. <br>
5번 라인 위에 // Debug TODO를 입력하기 위해 -를 입력해 5번 라인으로 이동한 후 O를 입력해서 편집 모드로 변경 합니다. <br>
Ctrl + N을 입력하면 자동 완성 기능을 사용할 수 있는데 Debug문자가 자동으로 완성되어서 Ctrl + N TODO를 입력하면 // Debug TODO가 완성 됩니다. <br>
