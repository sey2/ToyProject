...
L을 사용해 마지막 라인으로 이동한 후 qa를 입력해 이름 a인 매크로를 기록하기 시작합니다. <br>
5번 라인 위에 // Debug TODO를 입력하기 위해 -를 입력해 5번 라인으로 이동한 후 O를 입력해서 편집 모드로 변경 합니다. <br><br>
 
Ctrl + N을 입력하면 자동 완성 기능을 사용할 수 있는데 <br>
Debug문자가 자동으로 완성되어서 Ctrl + N TODO를 입력하면 // Debug TODO가 완성 됩니다. <br><br>
 
그 후 Esc키를 눌러 명령 행 모드로 진입 한 후 q를 누르면 매크로 기록이 중단이 되고 **@a**를 누르면 a매크로가 실행이 되고 <br>
기록해 놨던 -O// <C-N> TODO가 반복 수행이 되면 4번 라인에 // Version TODO가 입력 되고 **ZZ**를 눌러 vim을 빠져 나가면  <br>
**최고 점수인 20점이 나오게 됩니다.**
